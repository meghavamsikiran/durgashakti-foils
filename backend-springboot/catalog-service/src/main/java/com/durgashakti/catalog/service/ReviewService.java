...
public class ReviewService {
    ...
    public Map<String, Object> getProductReviews(UUID productId, int page, int limit) {
        ...
        // Manual pagination for simplicity or query
    ...
    public Map<String, Object> submitProductReview(UUID userId, UUID productId, UUID orderId, int rating,
        ...
        // Handle uploaded files - in Spring Boot we upload to static assets or a media service.
        // For local simulation or storage, we can mock the URL upload
    ...
    public Map<String, Object> getGoogleReviewsSummary() {
        // Simple mock / fallback logic or full Google Places API lookup:

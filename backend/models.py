...
class ProductReviewModel(Base):
    ...
    admin_reply_by = Column(UUID(as_uuid=True), nullable=True)
...
class OrderModel(Base):
    ...
    last_tracking_sync = Column(DateTime(timezone=True), nullable=True)
    tracking_events_json = Column(JSONB, default=list, nullable=False, server_default=text("'[]'::jsonb"))
    shipment_notes = Column(Text, nullable=True)

                    ...
                    >
                      {likes[i].liked ? (
                        ...
                        <svg 
                          ...
                          className="w-4 h-4"
                        >
                          <path strokeLinecap="round" strokeLinejoin="round" d="M6.633 10.25c.896 0 1.7-.33 2.312-.872L12.06 6.51c.3-.3.8-.2.9.2.298 1.102.6 2.11.9 2.91.4.998 1.4 1.63 2.5 1.63h3.5a1.75 1.75 0 0 1 1.75 1.75c0 .973-.77 1.75-1.75 1.75-.24 0-.46-.05-.67-.14a1.75 1.75 0 0 1-2.33 2.33c-.21.28-.5.5-.83.63a1.75 1.75 0 0 1-2.92 1.87H7.75a2.25 2.25 0 0 1-2.25-2.25V11.5a2.25 2.25 0 0 1 2.25-2.25h1.133ZM2.75 11.5c-.97 0-1.75.78-1.75 1.75v5c0 .97.78 1.75 1.75 1.75h1.5c.97 0 1.75-.78 1.75-1.75v-5c0-.97-.78-1.75-1.75-1.75h-1.5Z" />
                        </svg>
                      )}

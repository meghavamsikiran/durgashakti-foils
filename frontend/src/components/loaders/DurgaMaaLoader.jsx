...
const DurgaMaaLoader = () => {
  ...
  if (isMobile) {
    // Beautiful, lightweight SVG Durga Maa loader for mobile views
    return (
      <motion.div
        animate={{ 
        ...
        className="w-24 h-24 flex items-center justify-center bg-transparent"
  ...
  return (
    <div 
      ...
      style={{ mixBlendMode: 'multiply', border: 'none', outline: 'none' }}
    >
      <video 
        ref={videoRef}

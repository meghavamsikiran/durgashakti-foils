...
import { Mail, MessageSquare, Clock, Phone, Calendar, User, FileText, CheckCircle2, Circle, AlertCircle, X, Filter, Image as ImageIcon, Copy, Check, Search, Paperclip, Play, AlertOctagon, Send, Power } from 'lucide-react';
                    ...
                    actions: (
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className="px-3.5 py-1.5 rounded-lg border border-slate-200 text-slate-700 hover:bg-slate-55 hover:border-slate-300 font-bold transition-all text-[11px]"
                        >
                          View & Reply
                        </button>
                      </div>

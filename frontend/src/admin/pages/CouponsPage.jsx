  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[calc(100vh-160px)] w-full">
        ...
        <p className="text-xs text-slate-500 font-bold uppercase tracking-wider">Loading coupons and banners...</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-8 font-inter">
                          ...
                          <td className="px-6 py-4 text-center">
                            <button
                              ...
                              className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none border cursor-pointer ${
                                isActuallyActive ? 'bg-emerald-600 border-emerald-500 dark:bg-emerald-500 dark:border-emerald-400' : 'bg-slate-200 border-slate-300 dark:bg-[#1e2923] dark:border-[#37493f]'
                              }`}
                            >
                              <span
      ...
      {isModalOpen && createPortal((
        <div className="fixed inset-0 z-[99999] overflow-y-auto flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 sm:p-6 lg:p-8 transition-all duration-300">
          <div className="bg-card text-card-foreground rounded-3xl border border-border shadow-2xl w-full max-w-5xl max-h-[calc(100vh-4rem)] overflow-hidden font-sans flex flex-col">

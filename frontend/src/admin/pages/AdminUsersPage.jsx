  ...
  if (loading && rows.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[calc(100vh-160px)] w-full">
        ...
        <p className="text-xs text-slate-500 font-bold uppercase tracking-wider">Loading system administrators...</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden">
        <div className="overflow-x-auto overflow-y-auto admin-table-container-admins">

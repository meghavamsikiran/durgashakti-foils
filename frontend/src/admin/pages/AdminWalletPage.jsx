      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className={`p-6 rounded-3xl border transition-all ${
          ...
          <div className="flex flex-col justify-between h-full space-y-4">
                ...
                <div>
                  <div className="flex items-center gap-2">
                    ...
                    <span className={`px-2.5 py-0.5 rounded-full text-[10px] font-black uppercase tracking-wider ${
                      ...
                      {returnsEnabled ? 'REFUNDS ALLOWED' : 'REFUNDS BLOCKED (REPLACEMENTS ALLOWED)'}
                    </span>
                  </div>
                  <p className="text-xs font-medium text-slate-600 dark:text-slate-300 mt-1">
                    {returnsEnabled 
                      ? 'Customers can request refunds and cancellations for wallet-paid orders.'
                      : 'Refunds & cancellations are BLOCKED for wallet orders, but product replacements remain allowed.'
                    }
                  </p>
                </div>
              </div>
            ...
            <div className="pt-2 border-t border-slate-200 dark:border-white/10 flex items-center justify-between gap-3">
              <span className="text-[11px] font-bold text-slate-500">Refund Policy Toggle:</span>
              <button
              ...
              >
                ...
                {returnsEnabled ? 'Disallow Wallet Refunds' : 'Allow Wallet Refunds'}
              </button>
            </div>
          </div>
        </div>

  ...
  if (loading && rows.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[calc(100vh-160px)] w-full">
        ...
        <p className="text-xs text-slate-500 font-bold uppercase tracking-wider">Loading orders...</p>
      </div>
    );
  }
            ...
            <div className="space-y-4">
              <div className="space-y-1">
                ...
                <select
                  ...
                  className="w-full p-4 rounded-2xl border border-[#26322B] text-xs font-semibold bg-[#131B17] text-white focus:bg-[#19231F] focus:ring-2 focus:ring-primary focus:outline-none"
                >
                  <option value="India Post">India Post</option>
                  <option value="Speed Post">Speed Post</option>
                  <option value="DTDC">DTDC</option>
              ...
              <div className="space-y-1">
                ...
                <textarea
                  ...
                  className="w-full p-4 rounded-2xl border border-[#26322B] text-xs font-semibold bg-[#131B17] text-white focus:bg-[#19231F] focus:ring-2 focus:ring-primary focus:outline-none resize-none h-16"
                />
              </div>
              ...
              <div className="border-t border-slate-100 pt-4 space-y-4">
                ...
                <div className="space-y-1">
                  ...
                  <textarea
                    ...
                    className="w-full p-4 rounded-2xl border border-[#26322B] text-xs font-mono bg-[#131B17] text-white focus:bg-[#19231F] focus:ring-2 focus:ring-primary focus:outline-none resize-none h-32"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-1">
                ...
                <textarea
                  ...
                  className="w-full p-4 rounded-2xl border border-[#26322B] text-xs font-semibold bg-[#131B17] text-white focus:bg-[#19231F] focus:ring-2 focus:ring-primary focus:outline-none resize-none h-20"
                />
              </div>
            </div>
            <div className="flex gap-3">
                  ...
                  <>
                    {showRefundInfo ? (
                      <div className="text-[11px] font-bold text-left w-full sm:w-auto flex flex-wrap items-center gap-2">
                        {(() => {
                          const pMethod = (selectedOrderForModal.payment_method || '').toLowerCase();
                          const pStatus = (selectedOrderForModal.payment_status || '').toLowerCase();
                          ...
                          const customerPhone = selectedOrderForModal.shipping_address?.phone || selectedOrderForModal.user_phone;
